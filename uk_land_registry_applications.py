...
This data can be used for testing property registration systems or related applications.
"""
...
def print_application_types():
    """
    Print a formatted list of all application types in the collection.
    """
    print("### Core Application Types")
    for i, app_type in enumerate(uk_land_registry_applications["core_application_types"], 1):
        print(f"{i}. {app_type['name']}")
        print(f"   - Description: {app_type['description']}")
        print(f"   - Forms: {', '.join(app_type['forms'])}")
        print()

    print("### Additional Application Types")
    offset = len(uk_land_registry_applications["core_application_types"])
    for i, app_type in enumerate(uk_land_registry_applications["additional_application_types"], offset + 1):
        print(f"{i}. {app_type['name']}")
        print(f"   - Description: {app_type['description']}")
        print(f"   - Forms: {', '.join(app_type['forms'])}")
        print()
